...
const CmSalonMembershipPlan = (props) => {
            ...
            <div className="row">
              <div className="col-md-3">
                <div className="d-flex align-items-start">
                  <div>{Svg.search}</div>
                  <div>
                    <h6 className="mb-0 ml10">Treatment</h6>
              ...
              <div className="col-md-3">
                <div className="d-flex align-items-start">
                  <div>{Svg.map}</div>
                  <div>
                    <h6 className="mb-0 ml10">Postcode or Area</h6>
              ...
              <div className="col-md-4">
                <div className="d-flex align-items-start">
                  <div>{Svg.date}</div>
                  <div>
                    <h6 className="mb-0 ml10">Date & time</h6>
...
export default CmSalonMembershipPlan;
