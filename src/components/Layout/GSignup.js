...
import { HomeStyle } from "../../pages/Common/Home/HomeStyle";
...
const GSignup = (props) => {
  ...
  const validate = () => {
    ...
    if (dataState && dataState.password.trim() === "") {
      ...
      errors.password =
        "Password needs to be between 6 and 30 character long and contains 1 upper-case letter and a number";
    }
  ...
  return (
    <>
      ...
      <LoginWrapper className="">
        <GCommonStyle dataState={dataState} />
            ...
            <Col lg={12} md={12}>
              ...
              <Row>
                ...
                <Col md={5}>
                  <GButton
                    className={`${
                      dataState.agreeTerms ? "" : "disableButton"
                    } w-100 pointerEvents`}
                    onClick={() => sendForm()}
                  >
                    Create an Account
