...
import { GImageUploadSalonStyle } from "./GImageUploadSalonStyle";
...
const GImageUploadSalon = ({
  ...
  const handleOnChange = (e) => {
    ...
    if (e.target.files[0].size > 1000000) {
      let myColor = { background: "#ff385c", text: "#FFFFFF" };
      return notify.show(
        "Image size allowed upto 1000KB, Please select image under 1000KB",
        "custom",
        5000,
        myColor
      );
            ...
            <div className="d-flex align-items-center">
              <div>
                ...
                <Label htmlFor={id}>
                  ...
                  />
                  <span className="radius4 gimg_upload_salon">
